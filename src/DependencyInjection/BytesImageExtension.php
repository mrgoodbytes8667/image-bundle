...
class BytesImageExtension extends Extension implements ExtensionInterface
{
    ...
    public function load(array $configs, ContainerBuilder $container)
    {
        ...
        $definition->replaceArgument(2, $config['cache']['local']['success']['enable']);
        ...
        $definition->replaceArgument(5, $config['cache']['local']['fallback']['duration']);
        $definition->replaceArgument(6, $config['cache']['response']['success']['cached']['duration']);
        $definition->replaceArgument(7, $config['cache']['response']['success']['initial']['duration']);
        $definition->replaceArgument(8, $config['cache']['response']['fallback']['duration']);
